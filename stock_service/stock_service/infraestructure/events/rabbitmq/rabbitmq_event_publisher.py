import json
from stock_service.domain.ports.event_publisher_interface import IEventPublisher
from stock_service.infraestructure.events.rabbitmq.rabbitmq_connection import RabbitMQConnection
from stock_service.infraestructure.events.rabbitmq.config import RABBITMQ_EXCHANGE, RABBITMQ_QUEUE
